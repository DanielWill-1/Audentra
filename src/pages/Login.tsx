...
import { Mic, Mail, Lock, Eye, EyeOff, Shield, CheckCircle } from 'lucide-react';
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Access your saved voice forms, drafts, and team templates to continue your workflow seamlessly.
          </p>
        </div>
