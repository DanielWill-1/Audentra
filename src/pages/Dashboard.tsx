      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-8">
            {/* Team Templates */}
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-6">Team Templates</h2>
                  ...
                  <div className="flex items-center justify-between p-3 hover:bg-gray-50 rounded-lg cursor-pointer">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">Field Work</p>
                      </div>
                    </div>
                    <div className="flex items-center">
                      <Star className="w-4 h-4 text-yellow-400 fill-current" />
                ...
                <div className="space-y-3">
                  <div className="flex items-center text-sm">
                    ...
                    <div className="flex-1">
                      <span className="text-gray-900">Form verified on blockchain</span>
                  ...
                  <div className="flex items-center text-sm">
                    ...
                    <div className="flex-1">
                      <span className="text-gray-900">Voice summary generated</span>
                  ...
                  <div className="flex items-center text-sm">
                    ...
                    <div className="flex-1">
                      <span className="text-gray-900">Template shared with team</span>
